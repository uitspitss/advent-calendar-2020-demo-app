...
### Test (Jest, react-test-renderer, testing-library/react)
...
```sh
yarn add -D jest jest-dom jest-css-modules ts-jest babel-jest @types/jest jest-emotion react-test-renderer @types/react-test-renderer jest-date-mock @testing-library/react @testing-library/jest-dom @testing-library/user-event @testing-library/dom fetch-mock
```
...
```sh
yarn add twin.macro @emotion/babel-preset-css-prop tailwindcss
```
